<template>
  <view class="page layout-page">
    ...
    <scroll-view
      ...
      class="video-list-scroll layout-full"
      ...
      <uni-row class="video-list" :gutter="12" v-if="loading && isFirstLoad">
        <uni-col :span="8" class="video-item" v-for="n in 9" :key="n">
          <div class="video-image-warp">
            ...
            <view
              class="episode-count skeleton-bg"
              style="height: 32rpx; width: 80rpx"
            />
          </div>
          <view
            class="skeleton-bg"
            style="height: 32rpx; width: 80%; margin: 12rpx 0 8rpx 0"
          />

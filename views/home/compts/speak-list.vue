<template>
  ...
  >
    ...
    <swiper
      ...
      :next-margin="offsetBottom"
    >
      <swiper-item
        class="full-swiper-item"
        ...
        <view class="swiper-item">
          <view class="speak-item__img-warp">
            ...
            <image
              :src="item.coverImage"
              mode="aspectFill"
              class="speak-item__img"
            />
            <view class="speak-item__img-mask">
              <m-text bold :size="42" color="blue-grey-1" multipleLines>{{
                item.titleEN
              }}</m-text>
              <m-text
                :size="24"
              ...
              <view class="flex-between mt-50">
                <m-text :size="24" color="blue-grey-1" multipleLines
                  ># {{ item.tags.join("、") }}</m-text
                >
                <view
                  class="speak-btn"
                  :class="{
                ...
                >
                  <m-icon
                    type="icon-shengyin"
                    :color="audioPlaying ? 'primary-7' : 'grey-1'"
                    size="32"
                  />
                  <text
                    style="margin-left: 4px"
                    v-if="totalTime && audioPlaying"
                  >
...
const { data: list, runAsync: requestList } = useMRequest(
  homeServices.followSentenceList,
  {
    manual: true,
